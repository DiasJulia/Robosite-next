...
const HomePage = () => {
  ...
  <Container>
    ...
    <ThirdSection>
      ...
      <Row>
        <RowItem>
          <Image src={ Trophy } alt="Desenho de Troféu" />
          <h3>Competições</h3>
        ...
        <RowItem>
          <Image src={ MagGlasses } alt="Desenho de Lupa" />
          <h3>Pesquisa</h3>
        ...
        <RowItem>
          <Image src={ Chip } alt="Desenho de Processador" />
    ...
    <FourthSection>
      ...
      <Row justifyContent="center">
        <div>
          <Image src={ Trophy2 } alt="Desenho de troféu" />
          <h4>Premiações</h4>
          <Badge>32</Badge>
        </div>
        <div>
          <Image src={ Upload } alt="Desenho de Upload" />
          <h4>Artigos publicados</h4>
          <Badge>28</Badge>
        </div>
        <div>
          <Image src={ People } alt="Desenho de Upload" />
          <h4>Colaboradores</h4>
          <Badge>89</Badge>
        </div>
      </Row>
